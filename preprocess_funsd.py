    ...
    with open(
        ...
        for file in os.listdir(args.data_dir):
            ...
            with open(file_path, "r", encoding="utf8") as f:
                data = json.load(f)
            image_path = file_path.replace('adjusted_', '').replace("annotations", "images")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default=r"D:\Experiments\funsd\validation_data\adjusted_annotations"
    )
    parser.add_argument("--data_split", type=str, default="val")
    parser.add_argument("--output_dir", type=str, default="data_with_val")
